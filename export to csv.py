...
df = pd.DataFrame(results, columns=["id", "kode_provinsi", "nama_provinsi", "kode_kabupaten_kota", "nama_kabupaten_kota", "kelompok_usia", "jumlah_korban", "satuan", "tahun"])
...
print("Data telah disimpan dalam file Excel 'data_api.csv'") #csv / xlsx
